...
#include "../../Source/Threading/MoodyCamelQueue.h"
#include "../Collections/BufferTest.h"
#include "../Collections/ConcurrentBufferTest.h"
...
namespace {
  ...
  using TestedQueue  = Nuclex::Support::Threading::MoodyCamelQueue<
    TItem,
