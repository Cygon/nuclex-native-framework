...
namespace erthink {
  ...
  namespace NAMESPACE_ERTHINK_U2A_DETAILS {
    ...
    enum : uint64_t {
      UINT_E10 = 10000000000ULL,
      UINT_E11 = 100000000000ULL,
      UINT_E12 = 1000000000000ULL,
      UINT_E13 = 10000000000000ULL,
      UINT_E14 = 100000000000000ULL,
      UINT_E15 = 1000000000000000ULL,
      UINT_E16 = 10000000000000000ULL,
      UINT_E17 = 100000000000000000ULL,
      UINT_E18 = 1000000000000000000ULL,
      UINT_E19 = 10000000000000000000ULL
    };
    ...
    static __always_inline char *dec3(uint_fast32_t v, char *ptr, std::size_t force = 0) {
      assert(v < 1000u);
  ...
  static __maybe_unused char *u2a(
    uint32_t u32, char *const buffer /* upto 10 chars for 4`294`967`295 */
  ) {
    if(u32 < UINT_E4) {
      // fast pass
  ...
  static __maybe_unused char *u2a(
    uint64_t u64, char *const buffer /* upto 20 chars for 18`446`744`073`709`551`615 */
  ) {
  ...
  static inline char *i2a(
    int32_t i32, char *const buffer /* upto 11 chars for -2`147`483`648 */
  ) {
    char *ptr = buffer;
  ...
  static inline char *i2a(
    int64_t i64, char *const buffer /* upto 20 chars for -9`223`372`036`854`775`808 */
  ) {
    char *ptr = buffer;
