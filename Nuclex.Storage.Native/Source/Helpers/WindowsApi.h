...
#ifndef NUCLEX_STORAGE_HELPERS_WINDOWSAPI_H
#define NUCLEX_STORAGE_HELPERS_WINDOWSAPI_H
...
namespace Nuclex { namespace Storage { namespace Helpers {
  ...
  class WindowsApi {
    ...
    /// <summary>Checks if the error number indicates a permission problem</summary>
    /// <param name="errorNumber">Error code that will be checked</param>
    /// <returns>True if the specified error is a path error</returns>
    /// <remarks>
    ///   Any error that indicates a permission issue (access denied, etc.) is
    ///   covered under this.
    /// </remarks>
    public: static bool IsPermissionError(DWORD errorCode);
    ...
    /// </remarks>
    public: static bool IsPathError(DWORD errorCode);
    ...
    /// </param>
    /// <param name="resultHandle">
    ///   HRESULT that was returned by the failed function
    /// </param>
...
#endif // NUCLEX_STORAGE_HELPERS_WINDOWSAPI_H
