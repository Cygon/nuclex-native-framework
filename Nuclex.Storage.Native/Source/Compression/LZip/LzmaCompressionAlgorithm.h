...
#ifndef NUCLEX_STORAGE_COMPRESSION_LZIP_LZMACOMPRESSIONALGORITHM_H
#define NUCLEX_STORAGE_COMPRESSION_LZIP_LZMACOMPRESSIONALGORITHM_H
...
namespace Nuclex { namespace Storage { namespace Compression { namespace LZip {
  ...
  /// <summary>Provides compressors and decompressors using the LZMA algorithm</summary>
  class LzmaCompressionAlgorithm : public CompressionAlgorithm {
    ...
    /// <summary>Initializes the LZMA compression algorithm</summary>
    /// <param name="compressionQuality">
    ///   Compression quality passed to the LZMA encoder
    /// </param>
    public: LzmaCompressionAlgorithm(int compressionQuality = DefaultQuality);

    /// <summary>Frees all resources owned by the instance</summary>
    public: virtual ~LzmaCompressionAlgorithm() override = default;
...
#endif // NUCLEX_STORAGE_COMPRESSION_LZIP_LZMACOMPRESSIONALGORITHM_H
