...
namespace Nuclex { namespace Pixels { namespace PixelFormats {
  ...
  /// <summary>Describes the B8 G8 R8 A8 unsigned pixel format</summary>
  template<>
  struct PixelFormatDescription<PixelFormat::B8_G8_R8_A8_Unsigned> {
  ...
  /// <summary>Describes the B8 G8 R8 A8 signed pixel format</summary>
  template<>
  struct PixelFormatDescription<PixelFormat::B8_G8_R8_A8_Signed> {
