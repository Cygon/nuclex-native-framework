...
#ifndef NUCLEX_PIXELS_STORAGE_PNG_PNGBITMAPCODEC_H
#define NUCLEX_PIXELS_STORAGE_PNG_PNGBITMAPCODEC_H
...
namespace Nuclex { namespace Pixels { namespace Storage { namespace Png {
  ...
  /// <summary>Loads and saves images in the popular PNG file format</summary>
  class PngBitmapCodec : public BitmapCodec {

    /// <summary>Initializes a new PNG bitmap codec</summary>
    public: PngBitmapCodec();
    /// <summary>Frees all resources owned by the instance</summary>
    public: virtual ~PngBitmapCodec() = default;
...
#endif // NUCLEX_PIXELS_STORAGE_PNG_PNGBITMAPCODEC_H
