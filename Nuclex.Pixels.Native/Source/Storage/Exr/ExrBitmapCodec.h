...
#ifndef NUCLEX_PIXELS_STORAGE_EXR_EXRBITMAPCODEC_H
#define NUCLEX_PIXELS_STORAGE_EXR_EXRBITMAPCODEC_H
...
namespace Nuclex { namespace Pixels { namespace Storage { namespace Exr {
  ...
  /// <summary>Loads and saves images in the EXR high-dynamic-range file format</summary>
  class ExrBitmapCodec : public BitmapCodec {

    /// <summary>Initializes a new PNG bitmap codec</summary>
    public: ExrBitmapCodec();
    /// <summary>Frees all resources owned by the instance</summary>
    public: virtual ~ExrBitmapCodec() = default;
...
#endif // NUCLEX_PIXELS_STORAGE_EXR_EXRBITMAPCODEC_H
